          ...
          <div class="flex flex-wrap justify-center md:justify-start gap-6 md:gap-8 p-4">
            ...
            >
              ...
              <div class="pt-2">
                ...
                <!-- 标题 -->
                <h3 class="font-serif text-sm font-medium text-[var(--color-primary)] mb-2 line-clamp-2 leading-tight">
                  {{ post.title }}
                </h3>
                <!-- 内容预览 -->
                <p class="text-xs text-[var(--color-muted)] leading-relaxed line-clamp-4">
                  {{ post.content }}
                </p>
              </div>
            </div>
